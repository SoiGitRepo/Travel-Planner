...
class GlassContainerPlatformView: NSObject, FlutterPlatformView {
    ...
    init(frame: CGRect, viewId: Int64, args: Any?, messenger: FlutterBinaryMessenger) {
        ...
        let bottomConstant: CGFloat = bleedBottom ? 0 : dynamicOuterMargin
        ...
        if #available(iOS 13.0, *) {
            ...
            NSLayoutConstraint.activate([
                ...
                hosting.view.bottomAnchor.constraint(equalTo: containerView.bottomAnchor, constant: -bottomConstant)
            ])
        } else {
            ...
            NSLayoutConstraint.activate([
                ...
                blur.bottomAnchor.constraint(equalTo: containerView.bottomAnchor, constant: -bottomConstant)
            ])
        }
